...
const InputGroup = ({
    ...
    return (
        <div className="mb-6">
            <label
                htmlFor={name}
                className="block h-5 text-xs sm:text-sm font-bold text-slate-700 tracking-wider mb-1"
            >
                {label || 'Input Label'}
                {required && (
                ...
                <>
                    <div className="relative">
                        ...
                        <input
                            ...
                            } text-gray-900 text-sm rounded-xs placeholder-text-xs  focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm pl-10`}
                            onChange={onChange}
                            onFocus={onFocus}
                            name={name}
                            value={value}
