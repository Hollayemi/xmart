            ...
            <div className="overflow-y-scroll myScroll">
                ...
                <div className="w-full flex justify-center my-5">
                    <div className="flex p-3 border items-center">
                        ...
                        <Verification
                            check={getShopData && getShopData.verify}
                        />
                    </div>
                </div>
        ...
        <div className="flex items-center pl-3 border-l">
            <i
                className={`text-2xl font-medium ${
                    check ? 'text-green-500' : 'text-red-400'
                } `}
            >
                {!check ? <FaTimes /> : <FaCheckCircle />}
            </i>
            <div className="flex flex-col ml-4">
                {!check && <p className="text-sm font-bold">NOT</p>}
                <h5 className="text-xs font-bold text-gray-400">Verified</h5>
            </div>
        </div>
    );
};
