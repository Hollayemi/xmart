    ...
    <UserWrapper type="settings">
        <section className="mt-5 ml-5">
            ...
            <div className="max-w-[500px] mt-5">
                <Each
                    icon={<FaShoppingCart />}
                    message="crashing child Starting child process with node server.js crashing child Starting child process with node server.js"
                />
                <Each
                    icon={<FaShoppingCart />}
                    message="crashing child Starting child process with node server.js crashing child Starting child process with node server.js"
...
const Each = ({ icon, message, note, link, time }) => (
    <div className="flex items-start relative pb-4 border-b my-1 p-2 mx-">
        ...
        <div>
            ...
            <h5 className="absolute bottom-0 right-2 text-gray-300">{time}</h5>
        </div>
    </div>
);
