        ...
        <section>
            ...
            <div className="bg-slate-600 bg-opacity-75 pt-16 overflow-hidden sm:pt-0 absolute flex -mt-10 flex-col md:flex-row justify-between md:justify-evenly items-center h-full w-full px-4">
                <div className="w-full mx-3 sm:mx-0 sm:w-4/5 md:w-2/5 text-white">
                    <h1 className="text-4xl md:text-4xl xl:text-5xl  leading-20 topLine-height font-medium text-white mb-5">
                        <b className="text-blue-200">In Few Seconds:</b> <br />{' '}
                        <b className="mt-10 text-3xl">
                            Lets Create Your own style
                        </b>
                    </h1>
                    <h5>
                        Kemon-market is a showcasing website, we present the
                        products and services offered by a company or small
                        business to the customer, reinforcing the perception of
                        the brand.
                    </h5>
                    <h5 className="mt-4">h</h5>
                    {!userData.isSeller && (
            ...
            <div className="flex items-center justify-center mt-[100vh]">
                <div className="w-full flex flex-wrap items-center justify-center">
                    ...
                    />
                    <IconNoteFlex
                        note="Kemon-market provides quick access to common features
                        and commands. It is well organised, making it easy to
                        locate different tools and options"
                        icon={<FaDumpster />}
                    />
                </div>
            </div>
