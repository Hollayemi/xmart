...
const SuccessMessage = () => {
    ...
    return (
        <div className="flex text-center items-center flex-col">
            ...
            <a href={`https://mail.google.com/mail/u/${emailTo}/`} target="_blank">
                <button className="px-4 mt-1 py-2 w-28 rounded-md border shadow text-blue-500 bg-slate-50 cursor-pointer">Open Mail</button>
            </a>
        </div>
    )
};